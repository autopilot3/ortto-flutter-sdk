...
class FlutterOrttoPushSdkAndroid extends FlutterOrttoPushSdkPlatform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('flutter_ortto_push_sdk_android');

  /// Registers this class as the default instance of [FlutterOrttoPushSdkPlatform]
  static void registerWith() {
    FlutterOrttoPushSdkPlatform.instance = FlutterOrttoPushSdkAndroid();
  }
